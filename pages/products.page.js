...
constructor(page, iPhoneMod){
   ...
   // this.buyiPhone17e = page.locator('//p[@class="typography-chapternav-label"]').locator('//p[contains(.,"${iPhoneName}")]')
    this.buyiPhone17e = page.locator('p.typography-chapternav-label', {hasText: iPhoneName})
